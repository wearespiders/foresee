...
(function ($) {
    ...
    var VisualComposer = Backbone.View.extend({
        ...
        events:{
            ...
            "click #wpb-add-new-section":'createPageSection',
        ...
        addAll:function () {
            ...
            if (this.$content.find('> [data-element_type]:not(.wpb_mk_row_section)').length > 0) {
        ...
        dropButton:function (event, ui) {
            ...
            } else if (ui.draggable.is('#wpb-add-new-custom-box')) {
        ...
        updateRowsSorting:function () {
            _.defer(function (app) {
                var $rows = app.$content.find('> .wpb_mk_row_section');
                $rows.each(function () {
        ...
        setSortable:function () {
            ...
            $('.wpb_main_sortable').sortable({
                ...
                // cursorAt: { left: 10, top : 20 },
                cursor:"move",
                items:"> .wpb_mk_row_section", // wpb_sortablee
                handle:'.column_move',
                distance:0.5,
