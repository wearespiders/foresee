...
<?php endif; ?>
		<h3 class="mk-shortcode mk-fancy-title pattern-style mk-shortcode-heading" style="text-align:left;"><span><?php _e( 'Login', 'woocommerce' ); ?></span></h3>	
		<form method="post" class="login">
			<div class="mk-woo-form-section">
				<label for="username"><?php _e( 'Username or email', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input size="50" type="text" class="input-text" name="username" id="username" />
			</div>
			<div class="mk-woo-form-section">
				<label for="password"><?php _e( 'Password', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input size="50" class="input-text" type="password" name="password" id="password" />
			</div>
			<div class="clear"></div>

			<div class="mk-woo-form-section">
				<?php $woocommerce->nonce_field('login', 'login') ?>
				<input type="submit" class="mk-button three-dimension large mk-skin-button" name="login" value="<?php _e( 'LOGIN', 'woocommerce' ); ?>" />
	...
	<div class="col-2">
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				...
				<input type="submit" class="mk-button three-dimension small mk-skin-button" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
