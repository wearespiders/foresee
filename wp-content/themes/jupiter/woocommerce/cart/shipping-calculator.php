...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="mk-button three-dimension medium mk-skin-button mk-cal-shipping"><?php _e( 'UPDATE TOTALS', 'woocommerce' ); ?></button></p>
